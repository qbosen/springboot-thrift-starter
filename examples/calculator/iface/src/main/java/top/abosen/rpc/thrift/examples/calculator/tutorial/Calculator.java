 ...
 *  @generated
 */
package top.abosen.rpc.thrift.examples.calculator.tutorial;
...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2020-08-17")
public class Calculator {
   ...
   */
  public interface Iface extends top.abosen.rpc.thrift.examples.calculator.shared.SharedService.Iface {
  ...
  public interface AsyncIface extends top.abosen.rpc.thrift.examples.calculator.shared.SharedService .AsyncIface {
  ...
  public static class Client extends top.abosen.rpc.thrift.examples.calculator.shared.SharedService.Client implements Iface {
  ...
  public static class AsyncClient extends top.abosen.rpc.thrift.examples.calculator.shared.SharedService.AsyncClient implements AsyncIface {
  ...
  public static class Processor<I extends Iface> extends top.abosen.rpc.thrift.examples.calculator.shared.SharedService.Processor<I> implements org.apache.thrift.TProcessor {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends top.abosen.rpc.thrift.examples.calculator.shared.SharedService.AsyncProcessor<I> {
